...
#define DOT_DURATION          100     // Durée d'un point
#define DASH_DURATION         300     // Durée d'un tiret
#define SYMBOL_SPACE          100     // Espace entre symboles
#define LETTER_SPACE          700     // Espace entre lettres
#define WORD_SPACE            700     // Espace entre mots
